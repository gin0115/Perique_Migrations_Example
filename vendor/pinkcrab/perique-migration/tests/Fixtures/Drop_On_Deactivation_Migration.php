...
/**
 * Mock class used for deactivation which is set to drop table.
 *
...
class Drop_On_Deactivation_Migration extends Migration {

	public const TABLE_NAME = 'drop_on_deactivation';
