...
/**
 * Mock class used for not to uninstall which is set to drop table.
 *
...
class No_Drop_On_Uninstall_Migration extends Migration {

	public const TABLE_NAME = 'not_drop_on_uninstall';
